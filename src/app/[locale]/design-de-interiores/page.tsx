...
export async function generateMetadata({
  ...
  const t = await getTranslations({ locale, namespace: 'designDeInteriores' })
  return { title: `${t('hero').replace('\n', ' ')} — Carol Orofino` }
}
    ...
    <main className="bg-background">
      ...
      <section className="relative h-[75vh] min-h-[520px] w-full overflow-hidden">
        ...
        <div className="absolute bottom-0 left-0 right-0 px-8 pb-12 md:px-16 md:pb-16 text-center">
          ...
          <h1 className="font-display text-5xl md:text-7xl text-white tracking-wide leading-none whitespace-pre-line">
            {t('hero')}
          </h1>
        </div>
      </section>
